...
puts "Create store by name:\n"
new_store = gets.chomp

@store1 = Store.create(name: new_store)

if @store1.save
  puts "You have successfully added a new store to the table."
else
  puts "Error: missing fields"
  @store1.errors.full_messages.each do |message|
    puts message
  end
end